...
const SHORT_DEBUFF_DURATION := 18.0
const LONG_DEBUFF_DURATION := 45.0
const KB_MIN_ANGLE := 90.0
const KB_MAX_ANGLE := 360.0
const SMALL_KB_DIST := 13.0
const MED_KB_DIST := 25.0
const LARGE_KB_DIST := 100.0
const VACCUM_KB_DIST := 50.0
...
# Entropy
const ENTROPY_RADIUS := 11.0
const ENTROPY_LIFETIME := 0.6
const ENTROPY_COLOR := Color(1.0, 0.506, 0.235, 0.9)
# Dynamic Fluid (Donut)
const DYNAMIC_OUTTER := 25.0
const DYNAMIC_INNER := 10.0
const DYNAMIC_LIFETIME := 0.7
const DYNAMIC_COLOR := Color(0.541, 0.675, 0.76, 0.9)
const FIRE_DONUT_OUTTER := 27.0
const FIRE_DONUT_INNER := 10.0
const FIRE_DONUT_LIFETIME := 0.7
const FIRE_DONUT_COLOR := Color(1.0, 0.506, 0.235, 0.9)
# Water Crystal
const WATER_AOE_RADIUS := 10.0
const WATER_AOE_LIFETIME := 0.5
const WATER_AOE_COLOR := Color(0.541, 0.675, 0.76, 0.9)
# Wind Crystal
const WIND_AOE_RADIUS := 10.0
const WIND_AOE_LIFETIME := 0.6
const WIND_AOE_COLOR := Color(0.369, 0.628, 0.525, 0.9)
...
# Umbra Prox AoE
const UMBRA_RADIUS := 45.0
const UMBRA_LIFETIME := 0.6
const UMBRA_COLOR := Color(0.695, 0.152, 0.176, 0.832)
# Vaccum Wave
const VACCUM_RADIUS := 250.0
const VACCUM_LIFETIME := 0.3
const VACCUM_COLOR := Color(0.565, 0.682, 0.843, 0.5)
...
const LC_ID_KEYS := [LockonController.LC_1, LockonController.LC_2, 
	LockonController.LC_3, LockonController.LC_4, 
	LockonController.LC_5, LockonController.LC_6, 
	LockonController.LC_7, LockonController.LC_8]
...
const HEADWIND_ICON = preload("uid://685iu22c2pjq")
const TAILWIND_ICON = preload("uid://cxd3d2j2r0m32")

@onready var p3_boa_anim: AnimationPlayer = %P3BoAAnim
...
@onready var fire_triangle: Node3D = %FireTriangle
@onready var water_circle: Node3D = %WaterCircle
...
var lc_rotation_deg: float
var lc_direction_factor: float
...
var umbra_target_pos: Vector3
var current_lc_pos: Vector2
var lc_starting_positions: Array
...
func start_sequence(new_party: Dictionary) -> void:
	...
	lockon_controller.pre_load([LockonController.LC_1, LockonController.LC_2, LockonController.LC_3, LockonController.LC_4,
...
func instantiate_party(new_party):
	...
	lat_long = randi() % 2 == 0
	# Swap fire/water position if needed
	if !fire_left:
		var tmp = water_circle.global_position
		water_circle.global_position = fire_triangle.global_position
		fire_triangle.global_position = tmp
	# Rotate arena
	fire_triangle.global_position = fire_triangle.global_position.rotated(Vector3.DOWN, deg_to_rad(arena_rotation_deg))
	water_circle.global_position = water_circle.global_position.rotated(Vector3.DOWN, deg_to_rad(arena_rotation_deg))
	wind_diamond.global_position = wind_diamond.global_position.rotated(Vector3.DOWN, deg_to_rad(arena_rotation_deg))
